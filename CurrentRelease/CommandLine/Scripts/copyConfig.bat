...
IF "%PROCESSOR_ARCHITECTURE%" == "ARM64" (
    IF EXIST "%TIGHTENER_RELEASE_ROOT%CommandLine\Windows\ARM64\Tightener.exe" IF EXIST "%TIGHTENER_RELEASE_ROOT%CommandLine\Windows\ARM64\TightenerGW_Cpp.exe" (
        SET TIGHTENER_BINARIES=%TIGHTENER_RELEASE_ROOT%CommandLine\Windows\ARM64\
    )
)
