...
SET TIGHTENER_X64_BINARIES=%TIGHTENER_RELEASE_ROOT%CommandLine\Windows\

SET TIGHTENER_ARM_BINARIES=%TIGHTENER_RELEASE_ROOT%CommandLine\Windows\ARM64\

IF "%PROCESSOR_ARCHITECTURE%" == "ARM64" (
    IF EXIST "%TIGHTENER_ARM_BINARIES%Tightener.exe" IF EXIST "%TIGHTENER_ARM_BINARIES%TightenerGW_Cpp.exe" (
        SET TIGHTENER_BINARIES=%TIGHTENER_ARM_BINARIES%
    ) ELSE (
        SET TIGHTENER_BINARIES=%TIGHTENER_X64_BINARIES%
    )
) ELSE (
    SET TIGHTENER_BINARIES=%TIGHTENER_X64_BINARIES%
)
...
SET TIGHTENER_DEFAULT_RR_QUIT_DELAY_MS=10000
...
SET TIGHTENER_DEFAULT_REPL_QUIT_DELAY_MS=10000
